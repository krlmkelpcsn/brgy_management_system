...
<html lang="en">
	<head>
		...
		<title>Request of Certificate of Residency</title>
					...
					<div class="col-lg-5 m-b30">
						<?php
							...
							if (isset($_POST['post_msg'])) {
								$model->addRequest($_SESSION['sess2'], 6, $_POST['message']);
                				...
                				<h3>Document: Certificate of Residency</h3>
                				...
                				if ($mail->send()) {
                					echo "<script>window.open('residency2', '_self')</script>";
                				} 
                                else {
                					echo $mail->ErrorInfo;
                				}
										...
										<div class="row placeani" id="sent">
											<div class="col-lg-12">
												<select class="form-control" id="switch-page">
													...
													<option value="6" selected>Request Certificate of Residency (w/ pic)</option>
												</select>
											</div>
											<div class="col-lg-8">
												<br>
