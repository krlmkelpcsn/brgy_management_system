								...
								<div class="row">
									<div class="col-lg-6">
										<div class="new-user-list">
											...
											<div class="row">
											    <div class="col-lg-4">
													<img src="../assets/images/org-structure/<?php echo $image_unique; ?>.jpg" alt="User" style="width: 200px; height: 200px; border-radius: 50%;object-fit: cover;">
												</div>
												<div class="col-lg-3">
												    <h6>Position:</h6>
													<h6>Email:</h6>
													<h6>Rendered Service</h6>
												</div>
												<div class="col-lg-5">
												    <h6><?php echo $position; ?></h6>
													<h6><?php echo $unm; ?></h6>
													<h6><?php echo $rendered_service; ?></h6>
												</div>
											</div>
										</div>
										<hr>
