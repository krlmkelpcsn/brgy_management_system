		...
		<main class="ttr-wrapper" style="background-color: #F3F3F3;">
			<div class="container-fluid">
				<div class="db-breadcrumb">
					<h4 class="breadcrumb-title">Manage Programs</h4>
					<ul class="db-breadcrumb-list">
						<li><i class="ti-menu"></i>Programs</li>
					</ul>
				</div>  
				...
				<div class="row">
					<div class="col-lg-12 m-b30">
								...
								?>
								<div align="right">
									<a href="" class="btn green radius-xl" style="background-color: #267621;" data-toggle="modal" data-target="#add-announcement"><i class="ti-menu"></i><span>&nbsp;ADD NEW PROGRAM</span></a>&nbsp;
									<a href="archived-activities" class="btn red radius-xl" style=""><i class="ti-archive"></i><span>&nbsp;ARCHIVED PROGRAMS</span></a><br>
								</div>
													...
													<div class="modal-dialog modal-lg">
														<div class="modal-content">
															<div class="modal-header">
																<h4 class="modal-title"><img src="../assets/images/<?php echo $web_icon; ?>.png" style="width: 30px; height: 30px;">&nbsp;Edit Program</h4>
											...
											<div id="archive-<?php echo $row['id']; ?>" class="modal fade" role="dialog">
												<form class="edit-profile m-b30" method="POST" enctype="multipart/form-data">
													<div class="modal-dialog modal-lg">
														<div class="modal-content">
															<div class="modal-header">
																<h4 class="modal-title"><img src="../assets/images/<?php echo $web_icon; ?>.png" style="width: 30px; height: 30px;">&nbsp;Archive Program</h4>
																<button type="button" class="close" data-dismiss="modal">&times;</button>
															</div>
															<div class="modal-body">
								...
								<hr>
								<div align="right">
									<button type="button" class="btn red radius-xl" data-toggle="modal" data-target="#delete-announcement"><i class="ti-archive"></i><span>&nbsp;DELETE ALL PROGRAMS</span></button>
								...
								<div id="delete-announcement" class="modal fade" role="dialog">
									<form class="edit-profile m-b30" method="POST" enctype="multipart/form-data">
										<div class="modal-dialog modal-lg">
											<div class="modal-content">
												<div class="modal-header">
													<h4 class="modal-title"><img src="../assets/images/<?php echo $web_icon; ?>.png" style="width: 30px; height: 30px;">&nbsp;Delete Programs</h4>
													<button type="button" class="close" data-dismiss="modal">&times;</button>
												</div>
												<div class="modal-body">
													<div class="row">
												...
												<div class="modal-footer">
													<input type="submit" class="btn red radius-xl outline" name="delete_announcements" value="Confirm">
													<button type="button" class="btn red outline radius-xl" data-dismiss="modal">Close</button>
												</div>
											</div>
										</div>
								...
								<?php
									...
									if (isset($_POST['delete_announcements'])) {
										$model->deleteAnnouncements(1, 1);
										echo "<script>window.open('activities', '_self');</script>";
									}

								?>
								<!-- <div align="right">
									<a href="" class="btn green radius-xl" style="background-color: #267621;" data-toggle="modal" data-target="#add-announcement"><i class="ti-menu"></i><span>&nbsp;ADD NEW ACTIVITY</span></a>&nbsp;
									<a href="archived-activities" class="btn red radius-xl" style=""><i class="ti-archive"></i><span>&nbsp;ARCHIVED ACTIVITIES</span></a><br>
								</div> -->
								...
								<div id="add-announcement" class="modal fade" role="dialog">
									<form class="edit-profile m-b30" method="POST" enctype="multipart/form-data">
										<div class="modal-dialog modal-lg">
											<div class="modal-content">
												<div class="modal-header">
													<h4 class="modal-title"><img src="../assets/images/<?php echo $web_icon; ?>.png" style="width: 30px; height: 30px;">&nbsp;Add Program</h4>
													<button type="button" class="close" data-dismiss="modal">&times;</button>
												</div>
												<div class="modal-body">
													<div class="row">
														...
														<div class="form-group col-12">
															...
															<input type="file" name="image" accept="image/*" onchange="readURL(this, '')" style="text-align: center;" required></center>
