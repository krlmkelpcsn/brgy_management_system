			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-lg-12 m-b30">
								...
								<div align="right">
									<a href="blotters" class="btn green radius-xl" style="background-color: <?php echo $primary_color; ?>;"><i class="ti-agenda"></i><span>&nbsp;ACTIVE BLOTTER RECORDS</span></a>
								</div>
											...
											<div class="modal-content">
												...
												<div class="modal-body">
													<div class="row">
														...
														<div class="form-group col-6">
															<label class="col-form-label">Complaint's Sitio</label>
															<input class="form-control" type="text" name="event_title" required>
														</div>
													</div>
												</div>
