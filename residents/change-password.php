										...
										<form class="edit-profile" method="POST">
											<div class="">
												...
												<div class="form-group row">
													...
													<div class="col-sm-7">
														<input class="form-control" type="password" id="npass" name="npass" minlength="5" maxlength="20" id="password" style="border-radius: 5px;" required>
													</div>
												</div>
												<div class="form-group row">
													<label class="col-sm-2 col-form-label">Re-Type Password</label>
													<div class="col-sm-7">
														<input class="form-control" type="password" id="rpass" name="rpass" minlength="5" maxlength="20" id="confirm_password" style="border-radius: 5px;" required>
													</div>
												</div>
