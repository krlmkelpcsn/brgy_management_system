...
<html lang="en">
	<head>
		...
		<title>Archived Purok Leaders</title>
		...
		<main class="ttr-wrapper" style="background-color: #FCFCFC;">
			<div class="container-fluid">
				<div class="db-breadcrumb">
					<h4 class="breadcrumb-title">Manage Leaders</h4>
								...
								// 	    }
									...
									<?php
										if (isset($_POST['edit-head'])) {
											...
											echo "<script>window.open('archived-pleaders', '_self');</script>";
										}
									?>
									<div class="col-lg-9 col-md-12">
										<div align="right">
											<a href="purok-leaders" class="btn green radius-xl" style="float: right;background-color: <?php echo $primary_color; ?>;"><i class="ti-harddrives"></i><span>&nbsp;PUROK LEADERS</span></a><br>
										</div>
													...
													<div id="delete-<?php echo $row['id']; ?>" class="modal fade" role="dialog" data-backdrop="static" data-keyboard="false">
														<form class="edit-profile m-b30" method="POST" enctype="multipart/form-data">
															<div class="modal-dialog modal-lg">
																<div class="modal-content">
																	<div class="modal-header">
																		<h4 class="modal-title"><img src="../assets/images/<?php echo $web_icon; ?>.png" style="width: 30px; height: 30px;">&nbsp;Restore Purok Leader</h4>
																		<button type="button" class="close" data-dismiss="modal">&times;</button>
																	</div>
																	<div class="modal-body">
													...
													<div id="deletee-<?php echo $row['id']; ?>" class="modal fade" role="dialog" data-backdrop="static" data-keyboard="false">
														<form class="edit-profile m-b30" method="POST" enctype="multipart/form-data">
															<div class="modal-dialog modal-lg">
																<div class="modal-content">
																	<div class="modal-header">
																		<h4 class="modal-title"><img src="../assets/images/<?php echo $web_icon; ?>.png" style="width: 30px; height: 30px;">&nbsp;Remove Purok Leader</h4>
																		<button type="button" class="close" data-dismiss="modal">&times;</button>
																	</div>
																	<div class="modal-body">
