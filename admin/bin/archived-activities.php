			...
			<div class="container-fluid">
				<div class="db-breadcrumb">
					...
					<ul class="db-breadcrumb-list">
						<li><i class="ti-menu"></i>Archived Programs</li>
					</ul>
				</div>  
				...
				<div class="row">
					<div class="col-lg-12 m-b30">
								...
								?>
								<div align="right">
									<a href="activities" class="btn green radius-xl" style="float: right;background-color: #267621;"><i class="ti-menu"></i><span>&nbsp;PROGRAMS</span></a><br>
								</div>
										...
										<tbody>
													...
													<div class="modal-dialog modal-lg">
														<div class="modal-content">
															<div class="modal-header">
																<h4 class="modal-title"><img src="../assets/images/<?php echo $web_icon; ?>.png" style="width: 30px; height: 30px;">&nbsp;Restore Program</h4>
											...
											<?php 
												...
												if (isset($_POST['archive'])) {
													...
													echo "<script>window.open('archived-activities', '_self');</script>";
												}
								...
								<hr>
								<!-- <div align="right">
									<a href="activities" class="btn green radius-xl" style="float: right;background-color: #267621;"><i class="ti-menu"></i><span>&nbsp;ACTIVITIES</span></a><br>
								</div> -->
