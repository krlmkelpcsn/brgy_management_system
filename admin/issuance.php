			...
			<div class="container-fluid">
				<div class="db-breadcrumb">
					...
					<ul class="db-breadcrumb-list">
						<li><i class="ti-book"></i>Issuance Details</li>
					</ul>
				</div>  
					...
					<div class="col-lg-12 m-b30">
								...
								<?php
									...
									if (isset($_POST['add_announcement'])) {
										...
										$model->addAnnouncement2($price, 0, 0, $title, $details, $base, $unique, $date, '', '4');
								...
								<div class="table-responsive">
									<table id="table" class="table hover" style="width:100%">
										...
										<tbody>
											...
											?>
											<tr>
												<td style="background-color: <?php echo $primary_color; ?>;"><a href="../assets/images/announcement/<?php echo $row['image_unique']; ?>.png" target="_blank"><img src="../assets/images/announcement/<?php echo $row['image_unique']; ?>.png" style="width: 100%;"></a></td>
														...
														<div class="modal-content">
															...
															<div class="modal-body">
																...
																<div class="row">
																	...
																	<div class="form-group col-12" style="background-color: <?php echo $primary_color; ?>;">
																		<center>
																	...
																	<div class="form-group col-12">
																		...
																		<input class="form-control" name="price" type="number" value="<?=$row['price']; ?>" required>
																	</div>
																	<div class="form-group col-12">
											...
											<?php 
												...
												if (isset($_POST['edit'])) {
													...
													$model->editAnnouncement($_POST['price'],$_POST['title'], $_POST['details'], $_POST['date'], $edit_id);
