							...
							<div class="col-lg-4 col-xl-4">
								<aside  class="side-bar sticky-top">
									<div class="widget recent-posts-entry">
										<h6 class="widget-title">Recent Programs</h6>
										<?php
										$category = 1;
										$status = 1;
										...
										<div class="widget-post-bx">
											<div class="widget-post clearfix">
												<div class="ttr-post-media"><a href="program-details?id=<?php echo $row['id']; ?>"><img src="assets/images/announcement/<?php echo $row['image_unique']; ?>.jpg" style="height: 70px!important; object-fit: cover;" alt=""></a></div>
												<div class="ttr-post-info">
													<div class="ttr-post-header">
														<h6 class="post-title"><a href="program-details?id=<?php echo $row['id']; ?>"><?php echo $row['title']; ?></a></h6>
													</div>
													<ul class="media-post">
