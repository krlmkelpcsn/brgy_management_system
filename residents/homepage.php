									...
									<div class="col-lg-12">
										<div class="new-user-list">
											<div class="heading-bx left">
												<h2 class="m-b10 title-head"><?php echo $r_fname; ?> <?php echo $r_lname; ?><br><small style="font-size: 18px;"><?php echo $r_email; ?></small> </h2>
											</div>

											<h6>Barangay Poblacion - Resident</h6>
											<!--<h6><?php echo $r_birth_date; ?></h6>-->
