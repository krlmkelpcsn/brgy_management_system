<?php
	...
	$gender_filter = isset($_GET['id']) ? $_GET['id'] : '';
	...
	if(isset($_POST["export-pdf"])) { 
        ...
        if ($checkStatus != 0 || $checkStatus != "") {
	        ...
	        $rows = $model->displayResidentsFilter($gender_filter, $status);
		}
		else{
		    $rows = $model->displayResidentsFilter($gender_filter, $status);
		}
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-lg-12 m-b30">
                                ...
                                <center><h2><?php echo strtoupper($gender_filter); ?> RESIDENTS</h2></center>
