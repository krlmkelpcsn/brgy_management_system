		...
		<main class="ttr-wrapper" style="background-color: #FCFCFC;">
			<div class="container-fluid">
				<div class="db-breadcrumb">
					<h4 class="breadcrumb-title">Manage Staffs</h4>
					...
					<div class="col-lg-12 m-b30">
						<?php
							...
							if (isset($_POST['add_structure'])) {
								...
								if ($row = $res->fetch()) {
									db_update('org_structure',['contact_no'=>$contact_no,'address'=>$address],['id'=>$row['id']]);
						...
						<div class="row align-items d-flex">
							<div class="col-lg-3 col-md-12">
								<div class="heading-bx left">
									<h2 class="m-b10 title-head">Barangay <span>Staffs</span></h2>
								</div>
								<?php 
							...
							<div class="col-lg-9 col-md-12">
								<div align="right">
									<a href="" class="btn green radius-xl" style="background-color: <?php echo $primary_color; ?>;" data-toggle="modal" data-target="#add-announcement"><i class="ti-plus"></i><span>&nbsp;ADD STAFF</span></a>&nbsp;
									<a href="archived-staffs" class="btn red radius-xl"><i class="ti-archive"></i><span>&nbsp;ARCHIVED STAFFS</span></a><br>
								</div>
										...
										<tbody>
											...
											<div id="edit-<?php echo $row['id']; ?>" class="modal fade" role="dialog" data-backdrop="static" data-keyboard="false">
												<form class="edit-profile m-b30" method="POST" enctype="multipart/form-data" >
													<div class="modal-dialog modal-lg" >
														<div class="modal-content">
															<div class="modal-header">
																<h4 class="modal-title"><img src="../assets/images/<?php echo $web_icon; ?>.png" style="width: 30px; height: 30px;">&nbsp;Edit Barangay Staff Details</h4>
																<button type="button" class="close" data-dismiss="modal">&times;</button>
															</div>
															<div class="modal-body" >
											...
											<div id="delete-<?php echo $row['id']; ?>" class="modal fade" role="dialog" data-backdrop="static" data-keyboard="false">
												<form class="edit-profile m-b30" method="POST" enctype="multipart/form-data">
													<div class="modal-dialog modal-md">
														<div class="modal-content">
															<div class="modal-header">
																<h4 class="modal-title"><img src="../assets/images/<?php echo $web_icon; ?>.png" style="width: 30px; height: 30px;">&nbsp;Archive Barangay Staff</h4>
																<button type="button" class="close" data-dismiss="modal">&times;</button>
															</div>
															<div class="modal-body">
											...
											<?php
												...
												if (isset($_POST['edit'])) {
													...
													['contact_no'=>$_POST['contact_no'],'address'=>$_POST['address']],['id'=>$edit_id]);
                                                    ...
                                                    echo "<script>alert('Profile has been changed!');window.open('staffs','_self');</script>";
												}

												if (isset($_POST['archive'])) {
													$status = 100;
													$model->archiveOrgStructure($status, $_POST['delete-id']);
													echo "<script>alert('Profile has been archived!');window.open('staffs','_self');</script>";
												}
								...
								<div id="add-announcement" class="modal fade" role="dialog">
									<form class="edit-profile m-b30" method="POST" enctype="multipart/form-data">
										<div class="modal-dialog modal-lg">
											<div class="modal-content">
												<div class="modal-header">
													<h4 class="modal-title"><img src="../assets/images/<?php echo $web_icon; ?>.png" style="width: 30px; height: 30px;">&nbsp;Add New Staff</h4>
													<button type="button" class="close" data-dismiss="modal">&times;</button>
												</div>
												<div class="modal-body">
													<div class="row">
														...
														<div class="form-group col-8">
															<label class="col-form-label"><b>Name of the Staff</b></label>
												...
												<div class="modal-footer">
													<input type="submit" class="btn green radius-xl outline" name="add_structure" value="Add Staff">
													<button type="button" class="btn red outline radius-xl" data-dismiss="modal">Close</button>
												</div>
											</div>
										</div>
