					...
					<ul>
						...
						<li class="show">
							...
							<ul>
								...
								<li>
									<a href="guidelines" class="ttr-material-button" style="color: <?php echo $primary_color; ?>"><span class="ttr-label">Guidelines</span></a>
								</li>
								<li>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-lg-12 m-b30">
								...
								?>
								<div align="right">
									<a href="" class="btn green radius-xl" style="background-color: #267621;" data-toggle="modal" data-target="#add-announcement"><i class="ti-harddrives"></i><span>&nbsp;ADD NEW GUIDELINES</span></a>&nbsp;&nbsp;<a href="archived-guidelines" class="btn red radius-xl"><i class="ti-archive"></i><span>&nbsp;ARCHIVED GUIDELINES</span></a>
								</div>
													...
													<div class="modal-dialog modal-lg">
														<div class="modal-content">
															<div class="modal-header">
																<h4 class="modal-title"><img src="../assets/images/<?php echo $web_icon; ?>.png" style="width: 30px; height: 30px;">&nbsp;Edit Guidelines</h4>
											...
											<div id="archive-<?php echo $row['id']; ?>" class="modal fade" role="dialog">
												<form class="edit-profile m-b30" method="POST" enctype="multipart/form-data">
													<div class="modal-dialog modal-lg">
														<div class="modal-content">
															<div class="modal-header">
																<h4 class="modal-title"><img src="../assets/images/<?php echo $web_icon; ?>.png" style="width: 30px; height: 30px;">&nbsp;Archive Guidelines</h4>
																<button type="button" class="close" data-dismiss="modal">&times;</button>
															</div>
															<div class="modal-body">
...
<!-- 																	<div class="form-group col-12">
								...
								<hr>
								<div align="right">
									<button type="button" class="btn red radius-xl" data-toggle="modal" data-target="#delete-announcement"><i class="ti-archive"></i><span>&nbsp;DELETE ALL GUIDELINES</span></button>
								...
								<div id="delete-announcement" class="modal fade" role="dialog">
									<form class="edit-profile m-b30" method="POST" enctype="multipart/form-data">
										<div class="modal-dialog modal-lg">
											<div class="modal-content">
												<div class="modal-header">
													<h4 class="modal-title"><img src="../assets/images/<?php echo $web_icon; ?>.png" style="width: 30px; height: 30px;">&nbsp;Delete Guidelines</h4>
													<button type="button" class="close" data-dismiss="modal">&times;</button>
												</div>
												<div class="modal-body">
													<div class="row">
														<div class="form-group col-12">
															<p>Are you sure you want to ALL delete?</p>
														</div>
													</div>
												</div>
												<div class="modal-footer">
								...
								<div id="add-announcement" class="modal fade" role="dialog">
									<form class="edit-profile m-b30" method="POST" enctype="multipart/form-data">
										<div class="modal-dialog modal-lg">
											<div class="modal-content">
												<div class="modal-header">
													<h4 class="modal-title"><img src="../assets/images/<?php echo $web_icon; ?>.png" style="width: 30px; height: 30px;">&nbsp;Add Guidelines</h4>
													<button type="button" class="close" data-dismiss="modal">&times;</button>
												</div>
												<div class="modal-body">
													<div class="row">
