			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-lg-12 m-b30">
								<div align="right">
									<a href="" class="btn green radius-xl" style="background-color: #267621;" data-toggle="modal" data-target="#add-announcement"><i class="ti-plus"></i><span>&nbsp;ADD NEW RESIDENT</span></a>&nbsp;
                                ...
                                <div class="row">
    								...
    								<div class="form-group col-2">
    									<select class="form-control" name="voterStatus">
										    ...
										    <option value="No">Not a Registered Voter</option>
    									</select>
    								</div>
    								<div class="form-group col-2">
    									<select class="form-control" name="registeredOrNot">
    								...
    								<!--<div class="form-group col-2">
    									<select class="form-control" name="mortalityStatus">
    									    <option value="All">All Mortality Status</option>
    									    <option value="Null">Alive</option>
										    <option value="True">Deceased </option>
    									</select>
    								</div>-->
    								
    								<div class="form-group col-2">
    									<button type="submit" name="filter" class="btn blue radius-xl" style="background-color: #F4D735;"><i class="ti-search"></i>&nbsp;&nbsp;FILTER FIELDS</button>
    								</div>
    								<div class="form-group col-2">
										...
										<tbody>
											<?php
												...
												if (isset($_POST['filter'])) {
                                                    ...
                                                    $_SESSION['voterStatus'] = $_POST['voterStatus'];
                                                    $_SESSION['registeredOrNot'] = $_POST['registeredOrNot'];
                                                    $_SESSION['age'] = $_POST['age'];
                                                    
                                                    //echo $_POST['age'];
                                                    if($_SESSION['age'] == "Infant"){  
												            $age_from = 0;
												            $age_to = 1;
												        }else if ($_SESSION['age'] == "Minor") {
												            $age_from = 2;
												            $age_to = 17;
												        }else if ($_SESSION['age'] == "Adult") {
												            $age_from = 18;
												            $age_to = 59;
												        }
												        else if ($_SESSION['age'] == "Senior") {
												            $age_from = 60;
												            $age_to = 100;
												        }else if ($_SESSION['age'] =="All") {
												            $age_from = 0;
												            $age_to = 200;
												        }
												    if ($_POST['purok'] == "All" && $_POST['gender'] == "All" && $_POST['civil_status'] == "All") {
												        ...
												        if($_POST['registeredOrNot'] != "All"){
												            $registeredOrNot = "verified = '".$_POST['registeredOrNot']."' AND ";
												        }
												        else{
												            $registeredOrNot = "";
												        }
												        ...
												        $_SESSION['registeredOrNot'] = $registeredOrNot;
												        $_SESSION['age'] = $age;
												        
												        
												        $rows = $model->displayResidentsFiltered($purok, $gender, $civil_status, $voterStatus,$registeredOrNot, $status, $age);
												    }
												}
												...
												<div class="modal-body">
													<div class="row">
														...
														<div class="form-group col-7">
															<label class="col-form-label"><b>Family Income</b></label>
								...
								<?php
									...
									if (isset($_POST['add_resident'])) {
										...
										if ($email == "") {
											...
											$result = $model->addResident($r_id, $ext, $address3, $bplace, $occupation, $fname, $mname, $lname, $bdate, $gender, $civil_status, $address1, $address2, $res_since, $date, $resident_status, $contact, $income, $family);
											...
											$result = $model->addResident2($r_id, $ext, $address3, $bplace, $occupation, $fname, $mname, $lname, $bdate, $gender, $civil_status, $address1, $address2, $res_since, $date, $resident_status, $contact, $email, $digits_hash, $income, $family);
