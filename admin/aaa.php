												...
												<div class="modal-body">
													<div class="row">
														...
														<div class="form-group col-6">
															...
															<input class="form-control" type="text" name="contact" maxlength="30">
														</div>
														<div class="form-group col-6">
														...
														<div class="form-group col-6">
															<label class="col-form-label"><b>Default Password</b><br>(Default password will be sent to resident's email)</label>
								...
								<?php
									...
									if (isset($_POST['add_resident'])) {
										...
										if ($email == "") {
	                                        ...
	                                        $mail->setFrom("azraelgriffin.riego@gmail.com", 'Barangay Cuyab');
											$mail->addAddress($email);

											$mail->isHTML(true);
											$mail->Subject = 'Welcome to Cuyab Portal - Account Verification';
