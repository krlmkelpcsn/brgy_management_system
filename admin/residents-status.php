<?php
	...
	$special_status = isset($_GET['id']) ? $_GET['id'] : '';
	$gender_status = isset($_GET['gender']) ? $_GET['gender'] : '';
	
	if($special_status == '1'){
	    $status_txt = "PWD";
	}
	else if ($special_status == '2') {
	    $status_txt = "Solo Parent";
	}
	else if($special_status == '3'){
	    $status_txt = "Senior Citizen";
	}
	...
	if(isset($_POST["export-pdf"])) { 
		...
		$obj_pdf->SetTitle("BARANGAY POBLACION - RESIDENTS");   
		...
		<div align="center">
			...
			<h2 style="color: black;">'.strtoupper($status_txt).' RESIDENTS INFORMATION</h2>
		</div>
		...
		$rows = $model->displayResidentsStatus($special_status, $status);
			...
			<div class="container-fluid">
				<div class="db-breadcrumb">
					...
					<ul class="db-breadcrumb-list">
						<li><i class="ti-agenda"></i>Residents Status</li>
					</ul>
				</div>  
				...
				<div class="row">
					<div class="col-lg-12 m-b30">
                                ...
                                <center><h2><?php echo strtoupper($status_txt); ?> RESIDENTS</h2></center>
								...
								if ($gender_status == " ") {
									...
									$model = new Model();
									$_POST['search_purok'] = $gender_status;
								}
								...
								<form method="POST">
											<div class="row">
												...
												<div class="col-lg-5">
													<select class="form-control" name="search_purok" id="switch-page" required>
														<option value="all" <?php echo (isset($_POST['search_purok']) && $_POST['search_purok'] == "all") ? 'selected' : ''; ?>>All Residents</option>
														<option value="Male" <?php echo (isset($_POST['search_purok']) && $_POST['search_purok'] == "Male") ? 'selected' : ''; ?>>Male</option>
														<option value="Female" <?php echo (isset($_POST['search_purok']) && $_POST['search_purok'] == "Female") ? 'selected' : ''; ?>>Female</option>
													</select>
												</div>
												<div class="col-lg-2">
										...
										<tbody>
											<?php
                								...
                								if ($gender_status == "") {
                									...
                									$model = new Model();
													$rows = $model->displayResidentsStatusGender($special_status, $status, $_POST['search_purok']);
                								}
		...
		<script type="text/javascript">
			$(document).ready(function() {
				$('#switch-page').change( function() {
					if ($(this).val() == "all") {
						window.open('residents-status?id=<?php echo $special_status; ?>', '_self');
					}
					else if ($(this).val() == "Male") {
						window.open('residents-status?id=<?php echo $special_status; ?>&gender=Male', '_self');
					}
					else if ($(this).val() == "Female") {
						window.open('residents-status?id=<?php echo $special_status; ?>&gender=Female', '_self');
					}
				});
			});
