						...
						<div class="row">
							...
							<div class="col-lg-8 col-xl-8">
								<div class="recent-news blog-lg">
									...
									<div class="info-bx">
										<ul class="media-post">
											<li><i class="fa fa-calendar"></i> <?php echo date('M. d, Y', strtotime($row['date'])); ?> - <?php echo date('M. d, Y', strtotime($row['expiration_date'])); ?></li>
										</ul>
										...
										<div class="widget-post-bx">
											<div class="widget-post clearfix">
												...
												<div class="ttr-post-info">
													...
													<ul class="media-post">
														<li><a href="#" style="color: #023e8b;"><i class="fa fa-clock-o"></i> <?php echo date('M. d, Y', strtotime($row['date'])); ?> - <?php echo date('M. d, Y', strtotime($row['expiration_date'])); ?></a></li>
													</ul>
												</div>
											</div>
										</div>
