<?php
	...
	if (isset($_POST['save_pass'])) {
		...
		$model->editStructure($_POST['name'], $position_id, $_POST['rendered'], $edit_id);
							...
							<div class="col-lg-12 m-b30">
										...
										<form class="edit-profile" method="POST" enctype="multipart/form-data">
											...
											<div class="">
												...
												<div class="form-group row">
													<label class="col-sm-2 col-form-label"><b>Rendered Service</b></label>
													<div class="col-sm-7">
														<input class="form-control" name="rendered" type="text" value="<?php echo $row['rendered_service']; ?>" required>
													</div>
												</div>
												<div class="form-group row">
													<label class="col-sm-2 col-form-label"><b>Position</b></label>
													<div class="col-sm-7">
														<input class="form-control" type="text" value="<?php echo $position; ?>" readonly>
													</div>
												</div>
												<center><a href="../assets/images/org-structure/<?php echo $row['image_unique']; ?>.jpg" target="_blank"><img id="display-img" src="../assets/images/org-structure/<?php echo $row['image_unique']; ?>.jpg" style="width: 160px;height:210px; object-fit: cover;"></a></center>
												<div class="form-group row">
													<label class="col-sm-2 col-form-label"><b>Photo</b></label>
													<div class="col-sm-7">
														<input class="form-control" type="file" name="image" accept="image/*" style="border: 0px; padding: 0px;" id="input-img" onchange="readURL(this)">
													</div>
												</div>
											</div>
											<?php
