			...
			<div class="container-fluid">
				<div class="db-breadcrumb">
					...
					<ul class="db-breadcrumb-list">
						<li><i class="ti-user"></i>Barangay Official's Profiles</li>
					</ul>
				</div> 
						...
						<div class="row align-items d-flex">
							<div class="col-lg-3 col-md-12">
								<div class="heading-bx left">
									<h2 class="m-b10 title-head">Barangay Officials</h2>
								</div>
							</div>
							...
							<div class="col-lg-9 col-md-12">
								<div class="row" >
									...
									<?php
											...
											?>
											<div class="col-md-4" >
												<center style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);"><img src="../assets/images/org-structure/<?php echo $row['image_unique']; ?>.jpg" style="width: 70%;height: 220px; object-fit: cover;"><br>
												<b><?php echo $row['name']; ?></b><br>
												<?php echo $position; ?><br>
												<?php echo $row['rendered_service']; ?><br><br></center><br>
											</tr>
											</div>
											<?php
