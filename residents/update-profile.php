			...
			<div class="container-fluid">
				...
				<div class="row">
				            <div class="col-lg-3 m-b30">
				                ...
				                <hr>
				                <a href="update-photo" class="btn blue radius-xl" style="color: white;"><i class="ti-upload"></i> Update Photo</a>
										...
										<form class="edit-profile" method="POST">
											<div class="">
												<div class="form-group row">
													...
													<div class="col-sm-7">
														<input class="form-control" type="text" name="r_id_number" value="<?php echo $r_id; ?>" readonly>
												...
												<div class="form-group row">
													...
													<div class="col-sm-7">
														<input class="form-control" type="text" name="address" value="<?php echo $r_address; ?>" required>
													</div>
												</div>
												<!--<div class="form-group row">
												...
												<div class="form-group row">
													...
													<div class="col-sm-7">
														<input class="form-control" type="number" name="resident-since" value="<?php echo $r_resident_since; ?>" max="2023" readonly>
													</div>
												</div>
											</div>
											<div class="row">
												...
												<div class="col-sm-7">
													...
													<a href="homepage" class="btn-secondry radius-xl"><i class="ti-close"></i> &nbsp;  Cancel <?=$_SESSION['sess2'];?></a>
												</div>
											</div>
										</form>
