			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-lg-12 m-b30">
								...
								?>
								<div align="right">
									<a href="" class="btn green radius-xl" style="background-color: #267621;" data-toggle="modal" data-target="#add-announcement"><i class="ti-harddrives"></i><span>&nbsp;ADD NEW SERVICE</span></a>&nbsp;&nbsp;<a href="archived-instructions" class="btn red radius-xl"><i class="ti-archive"></i><span>&nbsp;ARCHIVED SERVICES</span></a>
								</div>
...
<!-- 																	<div class="form-group col-12">
								...
								<hr>
								<div align="right">
									<button type="button" class="btn red radius-xl" data-toggle="modal" data-target="#delete-announcement"><i class="ti-archive"></i><span>&nbsp;DELETE ALL SERVICES</span></button>
								...
								<div id="delete-announcement" class="modal fade" role="dialog">
									<form class="edit-profile m-b30" method="POST" enctype="multipart/form-data">
										<div class="modal-dialog modal-lg">
											<div class="modal-content">
												<div class="modal-header">
													<h4 class="modal-title"><img src="../assets/images/<?php echo $web_icon; ?>.png" style="width: 30px; height: 30px;">&nbsp;Delete Services</h4>
													<button type="button" class="close" data-dismiss="modal">&times;</button>
												</div>
												<div class="modal-body">
													<div class="row">
