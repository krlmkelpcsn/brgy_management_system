<?php
	...
	if(isset($_POST["residency"])) { 
		...
		ob_end_clean();
		$pdf->Output('I', 'Barangay Business Clearance.pdf');
	}
...
<html lang="en">
	<head>
		...
		<title>Request of Business Clearance </title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-lg-5 m-b30">
						<?php
							...
							if (isset($_POST['post_msg'])) {
								$model->addRequest2($_SESSION['sess2'], 4, $_POST['business_name'], $_POST['message']);

								setcookie('cancel_request_business', time() + (60 * 5), time() + (60 * 5), "/");
								
								
								
								$purpose = $_POST['business_name'];
                				...
                				<h3>Document: Business Clearance</h3>
                				<h3>Business Name: $purpose</h3>
                				<br><br>
                				At your service, <br>
										...
										<div class="row placeani" id="sent">
											<div class="col-lg-12">
												<select class="form-control" id="switch-page">
													...
													<option value="4" selected>Request Barangay Business Clearance (w/o pic)</option>
											...
											<div class="col-lg-12">
												...
												<p id="timer" style="text-align: center;">
														<?php
															...
															if (isset($_COOKIE['cancel_request_business'])) { 
																$time_left = $_COOKIE['cancel_request_business'] - time();
														...
														<div class="modal-content">
															...
															<div class="modal-body">
																...
																<div class="row">
																	...
																	<div class="form-group col-12">
																	    <label class="col-form-label"><b>Business Name</b></label>
																		<br><?php echo $row['business_name']; ?>
																	</div>
																	<div class="form-group col-12">
																	    <label class="col-form-label"><b>Business Address</b></label>
					...
					<div class="col-lg-7 m-b30">
						<div class="heading-bx left">
							<h2 class="title-head">Business Clearance<span> Request History</span></h2>
						</div>
