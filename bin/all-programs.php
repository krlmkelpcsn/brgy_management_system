        ...
        <div class="page-banner ovbl-dark" style="background-image:url(assets/images/cover.jpg);">
            <div class="container">
                <div class="page-banner-entry">
                    <h1 class="text-white"><?php echo $web_header; ?> Programs</h1>
				 </div>
            </div>
        </div>
							...
							<li class="action-card col-lg-6 col-md-6 col-sm-12 <?php echo $class_name; ?>">
								<div class="event-bx m-b30">
									<div class="action-box">
										<a href="program-details?id=<?php echo $row['id']; ?>"><img src="assets/images/announcement/<?php echo $row['image_unique']; ?>.jpg" style="height: 280px;object-fit: cover;" alt=""></a>
									</div>
									<div class="info-bx d-flex">
										...
										<div class="event-info">
											<h4 class="event-title"><a href="program-details?id=<?php echo $row['id']; ?>"><?php echo $row['title']; ?></a></h4>
											<ul class="media-post">
												<li><a href="#"><i class="fa fa-clock-o"></i> <?php echo date('g:i A', strtotime($row['date'])); ?></a></li>
											</ul>
											<p><?php echo substr($row['details'], 0, 150); ?><a href="program-details?id=<?php echo $row['id']; ?>" style="color: green;">.... See More</a></p>
										</div>
									</div>
								</div>
							</li>
