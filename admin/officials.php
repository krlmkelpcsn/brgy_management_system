		...
		<main class="ttr-wrapper" style="background-color: #FCFCFC;">
			<div class="container-fluid">
				<div class="db-breadcrumb">
					<h4 class="breadcrumb-title">Manage Officials</h4>
					...
					<div class="col-lg-12 m-b30">
						<?php
							...
							if (isset($_POST['add_structure'])) {
								$name = $_POST['name'];
								$email = $_POST['email'];
								$password = password_hash("12345x", PASSWORD_DEFAULT);
						...
						<div class="row align-items d-flex">
							<div class="col-lg-3 col-md-12">
								<div class="heading-bx left">
									<h2 class="m-b10 title-head">Barangay <span>Officials</span></h2>
								</div>
								<?php 
							...
							<div class="col-lg-9 col-md-12">
								<div align="right">
									<a href="" class="btn green radius-xl" style="background-color: <?php echo $primary_color; ?>;" data-toggle="modal" data-target="#add-announcement"><i class="ti-plus"></i><span>&nbsp;ADD OFFICIAL</span></a>&nbsp;
									<a href="archived-officials" class="btn red radius-xl"><i class="ti-archive"></i><span>&nbsp;ARCHIVED OFFICIALS</span></a><br>
								</div>
								...
								<div class="table-responsive">
									<table id="table" class="table hover" style="width:100%">
										...
										<tbody>
											...
											<div id="c-<?php echo $row['id']; ?>" class="modal fade" role="dialog" data-backdrop="static" data-keyboard="false">
												<form class="edit-profile m-b30" method="POST" enctype="multipart/form-data" >
													<div class="modal-dialog modal-lg" >
														<div class="modal-content">
															<div class="modal-header">
																<h4 class="modal-title"><img src="../assets/images/<?php echo $web_icon; ?>.png" style="width: 30px; height: 30px;">&nbsp;Edit Barangay Official Details</h4>
																<button type="button" class="close" data-dismiss="modal">&times;</button>
															</div>
															<div class="modal-body" >
																...
																<div class="row">
																	...
																	<div class="form-group col-8">
																		...
																		<option value="0" <?php if ($row['position'] == 0) { echo 'selected'; } ?>>Barangay Captain</option>
																			<option value="1" <?php if ($row['position'] == 1) { echo 'selected'; } ?>>Barangay Treasurer</option>
																			<option value="2" <?php if ($row['position'] == 2) { echo 'selected'; } ?>>Barangay Secretary</option>
																			<option value="3" <?php if ($row['position'] == 3) { echo 'selected'; } ?>>Barangay Kagawad</option>
																			<option value="4" <?php if ($row['position'] == 4) { echo 'selected'; } ?>>SK Chairperson</option>
											...
											<div id="delete-<?php echo $row['id']; ?>" class="modal fade" role="dialog" data-backdrop="static" data-keyboard="false">
												<form class="edit-profile m-b30" method="POST" enctype="multipart/form-data">
													<div class="modal-dialog modal-md">
														<div class="modal-content">
															<div class="modal-header">
																<h4 class="modal-title"><img src="../assets/images/<?php echo $web_icon; ?>.png" style="width: 30px; height: 30px;">&nbsp;Archive Barangay Official</h4>
																<button type="button" class="close" data-dismiss="modal">&times;</button>
															</div>
															<div class="modal-body">
											...
											<?php
												...
												if (isset($_POST['edit'])) {
                                                    ...
                                                    echo "<script>alert('Profile has been changed!');window.open('officials','_self');</script>";
												...
												if (isset($_POST['archive'])) {
													...
													echo "<script>alert('Profile has been archived!');window.open('officials','_self');</script>";
												}
								...
								<div id="add-announcement" class="modal fade" role="dialog">
									<form class="edit-profile m-b30" method="POST" enctype="multipart/form-data">
										<div class="modal-dialog modal-lg">
											<div class="modal-content">
												<div class="modal-header">
													<h4 class="modal-title"><img src="../assets/images/<?php echo $web_icon; ?>.png" style="width: 30px; height: 30px;">&nbsp;Add New Official</h4>
													<button type="button" class="close" data-dismiss="modal">&times;</button>
												</div>
												<div class="modal-body">
													<div class="row">
														...
														<div class="form-group col-8">
															<label class="col-form-label"><b>Name of the Official</b></label>
															...
															<option value="0">Barangay Captain</option>
																<option value="1">Barangay Treasurer</option>
																<option value="2">Barangay Secretary</option>
												...
												<div class="modal-footer">
													<input type="submit" class="btn green radius-xl outline" name="add_structure" value="Add Official">
													<button type="button" class="btn red outline radius-xl" data-dismiss="modal">Close</button>
												</div>
											</div>
										</div>
